...
dependencies {
    firebaseReleaseImplementation 'com.jeppeman.globallydynamic.android:selfhosted:0.1'
}
\`\`\`

### 3. Build and upload the APK

**Option 1: Build a standard APK (\`./gradlew assembleFirebaseRelease\`)**: this APK will *only* contain code and resources from the 
...
the APK.<br/><br/>
**Option 3: Build a universal APK (\`./gradlew buildUniversalApkForFirebaseRelease\`):** this APK will include *all* code and 
