...
import com.jeppeman.locallydynamic.gradle.extensions.stackTraceToString
import com.jeppeman.locallydynamic.gradle.extensions.unzip
import com.jeppeman.locallydynamic.gradle.generators.*
...
/**
 * A task that generates configuration source files which are necessary to interact with the locally dynamic server.
 * Used as follows: ./gradlew writeLocallyDynamicConfigurationSourceFilesFor<Flavor><BuildType> e.g
 * ./gradlew writeLocallyDynamicConfigurationSourceFilesForFreeDebug
 *
...
open class WriteConfigurationSourceFilesTask : DefaultTask() {
    ...
    fun doTaskAction() {
        ...
        val fileGenerators = listOf(
            ...
            LocallyDynamicBuildConfigGenerator(
    ...
    class CreationAction(
        ...
        override val name: String
            get() =
                applicationVariant.getTaskName("writeLocallyDynamicConfigurationSourceFilesFor")
