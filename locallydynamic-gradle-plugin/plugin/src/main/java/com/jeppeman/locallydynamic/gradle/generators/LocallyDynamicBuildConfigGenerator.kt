...
class LocallyDynamicBuildConfigGenerator(
    outputFile: File,
    ...
    private val usernameField = FieldSpec.builder(
        TypeNames.STRING,
        USERNAME_NAME,
        Modifier.STATIC, Modifier.PRIVATE, Modifier.FINAL)
        .initializer("\$S", username ?: "")
        .build()

    private val passwordField = FieldSpec.builder(
        TypeNames.STRING,
        PASSWORD_NAME,
        Modifier.STATIC, Modifier.PRIVATE, Modifier.FINAL)
        .initializer("\$S", password ?: "")
        .build()
    ...
    override val typeSpec: TypeSpec = TypeSpec.classBuilder(TypeNames.LOCALLY_DYNAMIC_BUILD_CONFIG)
        ...
        .addMethods(listOf(
            ...
            usernameField.asGetter("username"),
            passwordField.asGetter("password"),
