...
public class ExecutorImplTest {
    ...
    @Test
    public void whenTaskIsSuccessful_execute_shouldPostResultToForeground() {
    ...
    @Test
    public void whenTaskFails_execute_shouldPostErrorToForeground() {
    ...
    @Test
    public void schedule_shouldRunTaskAfterDelay() {
        final IllegalStateException exception = new IllegalStateException();
        Executor.Callbacks<String> callbacks = spy(new Executor.Callbacks<String>() {
            @Override
            String execute() {
    ...
    @Test
    public void schedule_shouldNotRunTasksBeforeDelay() {
        final IllegalStateException exception = new IllegalStateException();
        Executor.Callbacks<String> callbacks = spy(new Executor.Callbacks<String>() {
            @Override
            String execute() {
