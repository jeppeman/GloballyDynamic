...
class LoggerImplTest {
    ...
    fun i_shouldAddTagAndPrintlnToSystemOut() {
        ...
        assertThat(messageCaptor.firstValue.toString()).endsWith("LocallyDynamicServer: $message")
    }
    ...
    fun whenArgumentIsPlainText_e_shouldAddTagAndPrintlnToSystemErr() {
        ...
        assertThat(messageCaptor.firstValue).endsWith("LocallyDynamicServer: $message")
    }
    ...
    fun whenArgumentThrowable_e_shouldAddStacktraceAndTagAndPrintlnToSystemErr() {
        ...
        verify(mockErrorStream).println(messageCaptor.capture())
        assertThat(messageCaptor.firstValue).endsWith("LocallyDynamicServer: ${illegalStateException.stackTraceToString()}")
    }
    ...
    fun whenArgumentsAreMessageAndThrowable_e_shouldAddMessageAndStacktraceAndTagAndPrintlnToSystemErr() {
        ...
        verify(mockErrorStream).println(messageCaptor.capture())
        assertThat(messageCaptor.firstValue).endsWith("LocallyDynamicServer: $message: ${illegalStateException.stackTraceToString()}")
    }
}